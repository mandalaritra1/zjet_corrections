...
class util_binning :
    ...
    def __init__(self):
        ...
        self.mgen_axis = hist.axis.Variable([0, 5, 10, 20, 40, 60, 80, 100, 150, 200, 1000], name="mgen", label=r"Mass (GeV)")
        self.mreco_axis = hist.axis.Variable([0, 2.5, 5, 7.5, 10, 15, 20, 30, 40, 50, 60, 70, 80, 90, 100, 125, 150, 175, 200, 500, 1000] , name="mreco", label=r"$m_{RECO}$ (GeV)")
